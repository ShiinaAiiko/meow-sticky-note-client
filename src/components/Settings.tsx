					...
					{config.deviceType === 'Mobile' ? (
						...
						<>
							...
							<div className='settings-m-main'>
								<SettingsItemList menuType={config.pageConfig.settingPage.settingType}></SettingsItemList>
							</div>
						</>
					)}
				</div>
		...
		>
			...
			>
				<div className='settings-menu-item'>
					...
					<span className='name'>{t('sync')}</span>
				</div>
			</saki-menu-item>
		</saki-menu>
	)
